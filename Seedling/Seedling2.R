...
#Simulation: Salt 100 & 200, heat and without Priming 
# lucid has a flowchart of If statement 
...
decision_function <- function(x, varnames){
  ...
  Direkt_Kosten_without_Priming<- Heizmaterial + Strom + Samen + Bewaesserung + 
